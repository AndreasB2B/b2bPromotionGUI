...
namespace KN.B2B.Web.Migrations
{
    ...
    [Migration("20220329101009_changeOfPrice")]
    partial class changeOfPrice
    {
            ...
            modelBuilder.Entity("KN.B2B.Model.products.productPrice.B2BProductPrice", b =>
                {
                    ...
                    b.Property<int?>("fk_scaleIdscale_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KN.B2B.Model.products.productPrice.B2BProductPrice", b =>
                {
                    ...
                    b.HasOne("KN.B2B.Model.products.productPrice.B2BPriceScale", "fk_scaleId")
                        .WithMany()
                        .HasForeignKey("fk_scaleIdscale_id");
                });
